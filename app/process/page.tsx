...
export default function ProcessPage() {
  return <InnerPage eyebrow="Precision processing" title={<>Cut with intent.<br />Ship with confidence.</>} intro="A professional cutting programme for premium beef and mutton: deboned, portioned, chilled, checked, and exported to the exact requirements of GCC dining and food-service partners." image="/journey-processing.png">
